	...
	class News_Center_Posts_Grid_Widget extends WP_Widget {
		...
		public function __construct() {
			$news_center_grid_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-grid-section style-2',
				'description' => __( 'Retrive Posts Grid Widgets', 'universal-news' ),
			);
			parent::__construct(
				'news_center_magazine_grid_widget',
				__( 'Ascendoor Posts Grid Widget', 'universal-news' ),
