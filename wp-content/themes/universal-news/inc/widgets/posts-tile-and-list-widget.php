	...
	class News_Center_Posts_Tile_And_List_Widget extends WP_Widget {
		...
		public function __construct() {
			$news_center_tile_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-tile-list-section style-2',
				'description' => __( 'Retrive Tile And List Widgets', 'universal-news' ),
			);
			parent::__construct(
				'news_center_magazine_tile_list_widget',
				__( 'Ascendoor Tile And List Widget', 'universal-news' ),
		...
		public function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Section Title:', 'universal-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_label' ) ); ?>"><?php esc_html_e( 'View All Button:', 'universal-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_link' ) ); ?>"><?php esc_html_e( 'View All Button URL:', 'universal-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'universal-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'universal-news' ); ?></label>
